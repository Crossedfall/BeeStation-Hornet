...
if write_cl['changes']:
    ...
    repo.create_file(str(Path.cwd().joinpath(f"html/changelogs/AutoChangeLog-pr-{pr_number}.yml")), f"Automatic changelog generation for PR #{pr_number} [ci skip]", "Test", branch='master', committer=InputGitAuthor(git_name, git_email))
    print("Done!")
else:
